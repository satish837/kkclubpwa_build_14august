...
const validLandmarks = ["GoldSeGrowthOnLine", "GoldSeGrowthOffLine"];

export default function RegistationComponent() {
  const { gaUtm } = useSearchutm();
 ...
 useEffect(() => {
  ...
  { 
    ...
    const datafinal = {
      ...
      agentcode:'',
      landmark: validLandmarks.includes(landmark) ? 'GSG100' : '',
                ...
                <div className="registerField">
                  ...
                  <input
                    ...
                    onChange={(e) => { 
                      ...
                      setLastname(value.replace(/[^a-z ]/gi, '')); setlnErrors(''); } 
                    }
                  />
